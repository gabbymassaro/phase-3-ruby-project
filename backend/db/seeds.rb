...
trip7 = Trip.create(title: "Winter in Vancouver", start_date: "2024-12-15", end_date: "2024-12-22",
                    location_id: location7.id)
trip8 = Trip.create(title: "Roman Holiday", start_date: "2024-11-15", end_date: "2024-11-25",
                    location_id: location8.id)
trip9 = Trip.create(title: "Barcelona Beaches", start_date: "2024-07-01", end_date: "2024-07-10",
                    location_id: location9.id)
trip10 = Trip.create(title: "Bangkok Bazaar", start_date: "2024-11-05", end_date: "2024-11-12",
                     location_id: location10.id)
trip11 = Trip.create(title: "Hollywood Glamour", start_date: "2024-08-15", end_date: "2024-08-20",
                     location_id: location1.id)
trip12 = Trip.create(title: "Tokyo Tech Tour", start_date: "2024-12-01", end_date: "2024-12-05",
                     location_id: location4.id)
...
Activity.create(name: "Wine Tasting", price: 50.0, date: "2024-10-18", trip_id: trip7.id)

Activity.create(name: "Cooking Class", price: 40.0, date: "2024-11-10", trip_id: trip10.id)
